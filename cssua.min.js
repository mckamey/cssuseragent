...
g={userAgent:{},parse:function(b){var a={};b=(""+b).toLowerCase();if(!b)return a;var c=b.match(m);if(c)for(var e=0;e<c.length;e++){var f=c[e].indexOf("/"),d=c[e].substring(0,f);if(d&&d!=="mozilla"){if(d==="applewebkit")d="webkit";a[d]=c[e].substr(f+1)}}if(n.exec(b))a.aol=RegExp.$2;if(q.exec(b))a.opera=RegExp.$1;else if(s.exec(b))a.icab=RegExp.$1;else if(o.exec(b))a.ie=RegExp.$2;else if(r.exec(b))a.mspie=RegExp.$2;else if(p.exec(b))a.gecko=RegExp.$1;if(!a.blackberry&&t.exec(b))a.blackberry=RegExp.$1;
if(u.exec(b))a.mobile=RegExp.$1;if(a.safari)if(a.chrome||a.blackberry)delete a.safari;else a.safari=a.version?a.version:{"419":"2.0.4","417":"2.0.3","416":"2.0.2","412":"2.0","312":"1.3","125":"1.2","85":"1.0"}[parseInt(a.safari,10)]||a.safari;else if(a.opera&&a.version)a.opera=a.version;a.version&&delete a.version;return a},format:function(b){function a(f,d){f=f.split(".").join("-");var j=" ua-"+f;if(d){d=d.split(".").join("-");for(var h=d.indexOf("-");h>0;){j+=" ua-"+f+"-"+d.substring(0,h);h=d.indexOf("-",
h+1)}j+=" ua-"+f+"-"+d}return j}var c="",e;for(e in b)if(e&&b.hasOwnProperty(e))c+=a(e,b[e]);return c},encode:function(b){var a="",c;for(c in b)if(c&&b.hasOwnProperty(c)){if(a)a+="&";a+=encodeURIComponent(c)+"="+encodeURIComponent(b[c])}return a}};g.userAgent=g.parse(l);var k=g.format(g.userAgent);if(i.className)i.className+=k;else i.className=k.substr(1);return g}(document.documentElement,navigator.userAgent);